...
//Основні поля:
//
//main: містить основні дані про погоду, такі як температура, вологість та тиск.
//        wind: містить інформацію про вітер (швидкість).
//weather: масив погодних умов (наприклад, "ясно", "дощ").
//rain: містить інформацію про дощ (кількість дощу за останню годину).
//        Класи Main, Wind, Weather, Rain:
//
//Це вкладені класи, які визначають конкретні аспекти погодних даних:
//Main: включає температуру, вологість і тиск.
//Wind: включає швидкість вітру.
//        Weather: опис погодних умов.
//        Rain: кількість дощу за останню годину.
//Геттери та Сеттери:
//
//Для кожного поля є відповідні геттери та сеттери, які дозволяють встановлювати та отримувати значення цих полів.
//Метод toString:
//
//У класах Main, Wind, Weather, Rain можна реалізувати метод toString, щоб легко вивести дані у зручному вигляді, коли це необхідно.
